...
const AcceptPrompt = React.memo(({ id, isApproved }) => {
  ...
  // React.useEffect(() => {
  //   console.log('List.js::344 ', approvalApi)
  // }, [approvalApi])
  ...
  if (isApproved === false || isApproved === 0) {
    return (
      <div className="flex justify-center">
        <div className="text-red-600 bg-red-100 hover:bg-red-200 active:bg-red-200">
          <Icons.Terminate className="inline-block text-red-700 mx-0.5 mb-1" />
        </div>
      </div>
    )
  }
